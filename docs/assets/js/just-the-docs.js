...
{"0": {
    ...
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | 19 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | 24 | . | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | 4 | . | None | 1 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v5.50 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.8.0 | . | MPLAB® XC32 C/C++ Compiler v3.01 | . ",
    ...
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications | . | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | 4 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | 19 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | 24 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v5.45 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.7.0 | . | MPLAB® XC32 C/C++ Compiler v2.50 | . ",
    ...
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications | . | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | 4 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | 19 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | 24 | . New Features . New features added in this release are as follows: . | Applications migrated from csp repository to this new application repository for PIC32MZ DA development boards | . Known Issues . The current known issues are as follows: . | None | . Development Tools . | MPLAB® X IDE v5.40 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.6.0 | . | MPLAB® XC32 C/C++ Compiler v2.41 | . ",

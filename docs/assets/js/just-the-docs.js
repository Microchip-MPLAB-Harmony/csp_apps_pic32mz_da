...
{"0": {
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/mplab_harmony_license.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/adchs/adchs_polled/readme.html#adchs-polling",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/adchs/adchs_polled/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/adchs/adchs_polled/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/adchs/adchs_polled/readme.html#downloading-and-building-the-application"
  },"4": {
    "doc": "ADCHS polling",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the AN3 pin RB15 (Pin 36 of the J15) to the Vcc (Pin 1 of the J15) | Connect the COM port J5(UART-USB) to the computer using a micro USB cable | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the AN3 pin RB15 (Pin 36 of the J15) to the Vcc (Pin 1 of the J15) | Connect the COM port J5(UART-USB) to the computer using a micro USB cable | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/adchs/adchs_polled/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/adchs/adchs_polled/readme.html#running-the-application",
    "relUrl": "/apps/adchs/adchs_polled/readme.html#running-the-application"
  },"6": {
    "doc": "ADCHS polling",
    "title": "ADCHS polling",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/adchs/adchs_polled/readme.html",
    "relUrl": "/apps/adchs/adchs_polled/readme.html"
  },"7": {
    "doc": "Cache maintenance operations",
    "title": "Cache maintenance operations",
    "content": "This example demonstrates the cache maintenance operation by cleaning and invalidating the cache for the DMA buffers located in the cacheable SRAM region. ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/cache/cache_maintenance/readme.html#cache-maintenance-operations",
    "relUrl": "/apps/cache/cache_maintenance/readme.html#cache-maintenance-operations"
  },"8": {
    "doc": "Cache maintenance operations",
    "title": "Description",
    "content": "This example application shows how to use the cache maintenance APIs to avoid issues related to cache coherency when the data cache is enabled. The application uses the USART and the DMA PLIBs to demonstrate the cache maintenance APIs provided by the Cache peripheral library. It registers a callback with the DMA transmit and receive channels. The application first transmits a message using the DMA transmit channel and then schedules a read of ten characters using the DMA receive channel. Once the DMA read is complete, it reads the received data and echoes the same on the terminal using the DMA transmit channel. The application calls the DCACHE_CLEAN_BY_ADDR API on the write buffer before transmitting it. Calling this API copies the data from the cache memory to the main memory, thereby ensuring that the DMA peripheral uses the updated values in the write buffer. The application calls the DCACHE_INVALIDATE_BY_ADDR API on the read buffer after reception of data is complete by the DMA receive channel. Calling this API invalidates the cache region corresponding to the read buffer, thereby ensuring that the CPU reads the updated values in the read buffer from the main memory and into the cache. The cache maintenance operations are always performed on a cache line (1 cache line = 32 bytes), the read and write buffers must be aligned to a 32 byte boundary and must be a multiple of 32 bytes. For the same reason, the number of received and echoed back bytes is 10, the size of the receive and echo buffers is 32 bytes. ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/cache/cache_maintenance/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/cache/cache_maintenance/readme.html#downloading-and-building-the-application",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/cmp/cmp_configurable_reference/readme.html#cmp-configurable-reference",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/cmp/cmp_configurable_reference/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/cmp/cmp_configurable_reference/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/cmp/cmp_configurable_reference/readme.html#downloading-and-building-the-application"
  },"16": {
    "doc": "CMP configurable reference",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | Pin 27 (C2INB) on J15 is the negative input. Connect it to a voltage below the reference voltage (~2V from CVR peripheral) to trigger interrupt | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | Pin 27 (C2INB) on J15 is the negative input. Connect it to a voltage below the reference voltage (~2V from CVR peripheral) to trigger interrupt | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/cmp/cmp_configurable_reference/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/cmp/cmp_configurable_reference/readme.html#setting-up-the-hardware"
  },"17": {
    "doc": "CMP configurable reference",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the “USB to UART” COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application project using its IDE | Following message is output on console: | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/cmp/cmp_configurable_reference/readme.html#running-the-application",
    "relUrl": "/apps/cmp/cmp_configurable_reference/readme.html#running-the-application"
  },"18": {
    "doc": "CMP configurable reference",
    "title": "CMP configurable reference",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/cmp/cmp_configurable_reference/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/coretimer/coretimer_periodic_timeout/readme.html#coretimer-periodic-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/coretimer/coretimer_periodic_timeout/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/coretimer/coretimer_periodic_timeout/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/coretimer/coretimer_periodic_timeout/readme.html#downloading-and-building-the-application"
  },"22": {
    "doc": "CORETIMER periodic interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_daa_sk.X | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/coretimer/coretimer_periodic_timeout/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/coretimer/coretimer_periodic_timeout/readme.html#setting-up-the-hardware"
  },"23": {
    "doc": "CORETIMER periodic interrupt",
    "title": "Running the Application",
    "content": ". | Build and program the application project using its IDE | LED Blinks continuosly | . The following table provides the details of LED: . | Board | LED name | . | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/coretimer/coretimer_periodic_timeout/readme.html#running-the-application",
    "relUrl": "/apps/coretimer/coretimer_periodic_timeout/readme.html#running-the-application"
  },"24": {
    "doc": "CORETIMER periodic interrupt",
    "title": "CORETIMER periodic interrupt",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/coretimer/coretimer_periodic_timeout/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmac/dmac_memory_transfer/readme.html#dmac-memory-transfer",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmac/dmac_memory_transfer/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmac/dmac_memory_transfer/readme.html#downloading-and-building-the-application",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmac/dmac_memory_transfer/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/dmac/dmac_memory_transfer/readme.html#setting-up-the-hardware"
  },"29": {
    "doc": "DMAC memory transfer",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the “USB to UART” COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application project using its IDE | Following message is output on console: . | The LED indicates the success or failure: . | The LED is turned ON when the DMAC memory transfer is successful | . | . Following table provides LED names: . | Board | LED name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmac/dmac_memory_transfer/readme.html#running-the-application",
    "relUrl": "/apps/dmac/dmac_memory_transfer/readme.html#running-the-application"
  },"30": {
    "doc": "DMAC memory transfer",
    "title": "DMAC memory transfer",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmac/dmac_memory_transfer/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmac/dmac_usart_echo/readme.html#dmac-usart-echo",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmac/dmac_usart_echo/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmac/dmac_usart_echo/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/dmac/dmac_usart_echo/readme.html#downloading-and-building-the-application"
  },"34": {
    "doc": "DMAC usart echo",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmac/dmac_usart_echo/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/dmac/dmac_usart_echo/readme.html#setting-up-the-hardware"
  },"35": {
    "doc": "DMAC usart echo",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the “USB to UART” COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application project using its IDE | Following message is output on console: . | Type 10 characters in the terminal. It will echo back the received bytes and toggles the LED | . The following table provides the LED name: . | Board | LED Name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmac/dmac_usart_echo/readme.html#running-the-application",
    "relUrl": "/apps/dmac/dmac_usart_echo/readme.html#running-the-application"
  },"36": {
    "doc": "DMAC usart echo",
    "title": "DMAC usart echo",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmac/dmac_usart_echo/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmt/dmt_timeout/readme.html#dmt-timeout",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmt/dmt_timeout/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmt/dmt_timeout/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/dmt/dmt_timeout/readme.html#downloading-and-building-the-application"
  },"40": {
    "doc": "DMT timeout",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmt/dmt_timeout/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/dmt/dmt_timeout/readme.html#setting-up-the-hardware"
  },"41": {
    "doc": "DMT timeout",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application project using its IDE | Console displays the following message: . | The deadman timer is fed periodically using Core Timer (CoreTimer) to prevent the DMT reset and the LED is toggled | Press the switch to put the system in deadlock (LED should stop blinking) | Following table provides switch and LED name . | Board | Switch name | LED name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | SW1 | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | SW1 | LED1 | . |   |   |   | . | Console displays the following message: . | The DMT will reset the device with in 12 seconds and the demonstration should restart | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmt/dmt_timeout/readme.html#running-the-application",
    "relUrl": "/apps/dmt/dmt_timeout/readme.html#running-the-application"
  },"42": {
    "doc": "DMT timeout",
    "title": "DMT timeout",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/dmt/dmt_timeout/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_interrupt/readme.html#gpio-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_interrupt/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_interrupt/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/gpio/gpio_led_on_off_interrupt/readme.html#downloading-and-building-the-application"
  },"46": {
    "doc": "GPIO interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_interrupt/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/gpio/gpio_led_on_off_interrupt/readme.html#setting-up-the-hardware"
  },"47": {
    "doc": "GPIO interrupt",
    "title": "Running the Application",
    "content": ". | Build and program the application project using its IDE | The LED is turned ON when the switch is pressed and turned OFF when the switch is released | . The following table provides the switch and the LED name: . | Board | Switch name | LED name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | SW1 | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | SW1 | LED1 | . |   |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_interrupt/readme.html#running-the-application",
    "relUrl": "/apps/gpio/gpio_led_on_off_interrupt/readme.html#running-the-application"
  },"48": {
    "doc": "GPIO interrupt",
    "title": "GPIO interrupt",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_interrupt/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_polling/readme.html#gpio-polling",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_polling/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_polling/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/gpio/gpio_led_on_off_polling/readme.html#downloading-and-building-the-application"
  },"52": {
    "doc": "GPIO Polling",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_polling/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/gpio/gpio_led_on_off_polling/readme.html#setting-up-the-hardware"
  },"53": {
    "doc": "GPIO Polling",
    "title": "Running the Application",
    "content": ". | Build and program the application project using its IDE | The LED is turned ON when the switch is pressed and turned OFF when the switch is released | . The following table provides the switch and the LED name: . | Board | Switch name | LED name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | SW1 | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | SW1 | LED1 | . |   |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_polling/readme.html#running-the-application",
    "relUrl": "/apps/gpio/gpio_led_on_off_polling/readme.html#running-the-application"
  },"54": {
    "doc": "GPIO Polling",
    "title": "GPIO Polling",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_polling/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/i2c/master/i2c_eeprom/readme.html#i2c-eeprom-read-write",
    "relUrl": "/apps/i2c/master/i2c_eeprom/readme.html#i2c-eeprom-read-write"
  },"56": {
    "doc": "I2C EEPROM read write",
    "title": "Description",
    "content": "This example uses the I2C peripheral library to write an array of values to the I2C Serial EEPROM and verify the value written by reading the values back and comparing it to the value written. The demo uses the on-board I2C based Serial EEPROM AT24MAC402. ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/i2c/master/i2c_eeprom/readme.html#description",
    "relUrl": "/apps/i2c/master/i2c_eeprom/readme.html#description"
  },"57": {
    "doc": "I2C EEPROM read write",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/i2c/master/i2c_eeprom/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | pic32mz_da_curiosity.X | MPLABX project for PIC32MZ DA Curiosity Development Kit | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/i2c/master/i2c_eeprom/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/i2c/master/i2c_eeprom/readme.html#downloading-and-building-the-application"
  },"58": {
    "doc": "I2C EEPROM read write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_da_curiosity.X | PIC32MZ DA Curiosity Development Kit | . |   |   | . Setting up PIC32MZ DA Curiosity Development Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/i2c/master/i2c_eeprom/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/i2c/master/i2c_eeprom/readme.html#setting-up-the-hardware"
  },"59": {
    "doc": "I2C EEPROM read write",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE -LED indicates the success or failure: . | LED is turned ON when the value read from the EEPROM matched with the written value | LED is turned OFF when the value read from the EEPROM did not match with the written value | . | . Following table provides LED names: . | Board | LED name | . | PIC32MZ DA Curiosity Development Kit | LED1 (Red) | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/i2c/master/i2c_eeprom/readme.html#running-the-application",
    "relUrl": "/apps/i2c/master/i2c_eeprom/readme.html#running-the-application"
  },"60": {
    "doc": "I2C EEPROM read write",
    "title": "I2C EEPROM read write",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/i2c/master/i2c_eeprom/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/icap/icap_capture_mode/readme.html#icap-capture-mode",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/icap/icap_capture_mode/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/icap/icap_capture_mode/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/icap/icap_capture_mode/readme.html#downloading-and-building-the-application"
  },"64": {
    "doc": "ICAP capture mode",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the OC3 pin RG8 (Pin 19 of the J15) to the IC1 pin RD0 (pin 24 of the J15) | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the OC3 pin RG8 (Pin 19 of the J15) to the IC1 pin RD0 (pin 24 of the J15) | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/icap/icap_capture_mode/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/icap/icap_capture_mode/readme.html#running-the-application",
    "relUrl": "/apps/icap/icap_capture_mode/readme.html#running-the-application"
  },"66": {
    "doc": "ICAP capture mode",
    "title": "ICAP capture mode",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/icap/icap_capture_mode/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/nvm/flash_read_write/readme.html#nvm-flash-read-write",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/nvm/flash_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/nvm/flash_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/nvm/flash_read_write/readme.html#downloading-and-building-the-application"
  },"70": {
    "doc": "NVM flash read write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/nvm/flash_read_write/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/nvm/flash_read_write/readme.html#setting-up-the-hardware"
  },"71": {
    "doc": "NVM flash read write",
    "title": "Running the Application",
    "content": ". | Build and program the application project using its respective IDE | LED indicates the success or failure: . | LED is turned ON when the value read from the Flash matched with the written value | . | . Following table provides the LED name: . | Board | LED name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/nvm/flash_read_write/readme.html#running-the-application",
    "relUrl": "/apps/nvm/flash_read_write/readme.html#running-the-application"
  },"72": {
    "doc": "NVM flash read write",
    "title": "NVM flash read write",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/nvm/flash_read_write/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/ocmp/ocmp_compare_mode/readme.html#ocmp-compare-mode",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/ocmp/ocmp_compare_mode/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/ocmp/ocmp_compare_mode/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/ocmp/ocmp_compare_mode/readme.html#downloading-and-building-the-application"
  },"76": {
    "doc": "OCMP compare mode",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/ocmp/ocmp_compare_mode/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/ocmp/ocmp_compare_mode/readme.html#setting-up-the-hardware"
  },"77": {
    "doc": "OCMP compare mode",
    "title": "Running the Application",
    "content": ". | Build and program the application project using its IDE | Observe active low, active high and toggle output on the oscilloscope . | Refer the following table for pin details: . | OCMP output | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit pins | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) pins | . | OC1 output | RD0 (Pin 24 of J15) | RD0 (Pin 24 of J15) | . | OC2 output | RB2 (Pin 27 of J15) | RB2 (Pin 27 of J15) | . | OC3 output | RD14 (Pin 26 of J15) | RD14 (Pin 26 of J15) | . |   |   |   | . | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/ocmp/ocmp_compare_mode/readme.html#running-the-application",
    "relUrl": "/apps/ocmp/ocmp_compare_mode/readme.html#running-the-application"
  },"78": {
    "doc": "OCMP compare mode",
    "title": "OCMP compare mode",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/ocmp/ocmp_compare_mode/readme.html",
    "relUrl": "/apps/ocmp/ocmp_compare_mode/readme.html"
  },"79": {
    "doc": "RNG random number",
    "title": "RNG random number",
    "content": "This example application shows how to use the RNG Peripheral library to generate a pseudo-random number. ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/rng/rng_random_number/readme.html#rng-random-number",
    "relUrl": "/apps/rng/rng_random_number/readme.html#rng-random-number"
  },"80": {
    "doc": "RNG random number",
    "title": "Description",
    "content": "The RNG peripheral has two blocks. One of them is called True Random Number Generator (TRNG) and the other is called Pseudo-Random Number Generator (PRNG). The TRNG generates true random numbers that can be used as seed for the PRNG. The PRNG can generate random numbers of up to 64-bits of length. This application shows how to generate a 64-bit pseudo-random number with the help of PRNG and TRNG. ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/rng/rng_random_number/readme.html#description",
    "relUrl": "/apps/rng/rng_random_number/readme.html#description"
  },"81": {
    "doc": "RNG random number",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/rng/rng_random_number/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | pic32mz_das_sk.X | MPLABX project for PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/rng/rng_random_number/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rng/rng_random_number/readme.html#downloading-and-building-the-application"
  },"82": {
    "doc": "RNG random number",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/rng/rng_random_number/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/rng/rng_random_number/readme.html#setting-up-the-hardware"
  },"83": {
    "doc": "RNG random number",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application project using its IDE | Press the switch to generate a 64-bit pseudo-random number (Refer to the table below for switch details) . | Board | Switch name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | SW1 | . |   |   | . | Observe the following output in the console: . | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/rng/rng_random_number/readme.html#running-the-application",
    "relUrl": "/apps/rng/rng_random_number/readme.html#running-the-application"
  },"84": {
    "doc": "RNG random number",
    "title": "RNG random number",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/rng/rng_random_number/readme.html",
    "relUrl": "/apps/rng/rng_random_number/readme.html"
  },"85": {
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/rtcc/rtcc_alarm/readme.html#rtcc-alarm-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/rtcc/rtcc_alarm/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/rtcc/rtcc_alarm/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/rtcc/rtcc_alarm/readme.html#downloading-and-building-the-application"
  },"88": {
    "doc": "RTCC alarm interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/rtcc/rtcc_alarm/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/rtcc/rtcc_alarm/readme.html#running-the-application",
    "relUrl": "/apps/rtcc/rtcc_alarm/readme.html#running-the-application"
  },"90": {
    "doc": "RTCC alarm interrupt",
    "title": "RTCC alarm interrupt",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/rtcc/rtcc_alarm/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/spi/spi_self_loopback_interrupt/readme.html#spi-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/spi/spi_self_loopback_interrupt/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/spi/spi_self_loopback_interrupt/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/spi/spi_self_loopback_interrupt/readme.html#downloading-and-building-the-application"
  },"99": {
    "doc": "SPI interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Use a jumper wire to short pin 21 and pin 19 of the J15 connector | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Use a jumper wire to short pin 21 and pin 19 of the J15 connector | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/spi/spi_self_loopback_interrupt/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/spi/spi_self_loopback_interrupt/readme.html#setting-up-the-hardware"
  },"100": {
    "doc": "SPI interrupt",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | LED indicates the success or failure: . | LED is turned ON when the when the value received matched with the transmitted value | LED is turned OFF when the when the value received did not match with the transmitted value | . | . Following table provides LED names: . | Board | LED name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/spi/spi_self_loopback_interrupt/readme.html#running-the-application",
    "relUrl": "/apps/spi/spi_self_loopback_interrupt/readme.html#running-the-application"
  },"101": {
    "doc": "SPI interrupt",
    "title": "SPI interrupt",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/spi/spi_self_loopback_interrupt/readme.html",
    "relUrl": "/apps/spi/spi_self_loopback_interrupt/readme.html"
  },"102": {
    "doc": "SQI flash read write",
    "title": "SQI flash read write",
    "content": "This example application demonstrates how to use the SQI Peripheral library to perform erase, write and read operation with the SQI Serial Flash memory. ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/sqi/sqi_read_write/readme.html#sqi-flash-read-write",
    "relUrl": "/apps/sqi/sqi_read_write/readme.html#sqi-flash-read-write"
  },"103": {
    "doc": "SQI flash read write",
    "title": "Description",
    "content": "This example uses the SQI peripheral library to erase and write an array of values to the SQI Serial Flash memory. It verifies the value written by reading the values back and comparing it to the value written. ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/sqi/sqi_read_write/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/sqi/sqi_read_write/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/sqi/sqi_read_write/readme.html#downloading-and-building-the-application"
  },"105": {
    "doc": "SQI flash read write",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_daa_sk.X | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/sqi/sqi_read_write/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/sqi/sqi_read_write/readme.html#setting-up-the-hardware"
  },"106": {
    "doc": "SQI flash read write",
    "title": "Running the Application",
    "content": ". | Build and program the application using the its IDE | Switch LED is turned ON to indicate waiting for switch press | Press the Switch to start the SQI Transfer. Switch LED is turned OFF once switch is pressed | The Success LED is turned ON when the value read from the SQI Serial Flash memory matched with the written value | . Following table provides the LED names and switch name: . | Kit Name | Success LED Name | Switch LED Name | Switch Name | . | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | LED3 | LED1 | SW3 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | LED3 | LED1 | SW3 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED3 | LED1 | SW3 | . |   |   |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/sqi/sqi_read_write/readme.html#running-the-application",
    "relUrl": "/apps/sqi/sqi_read_write/readme.html#running-the-application"
  },"107": {
    "doc": "SQI flash read write",
    "title": "SQI flash read write",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/sqi/sqi_read_write/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/tmr/tmr_timer_mode/readme.html#tmr-periodic-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/tmr/tmr_timer_mode/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/tmr/tmr_timer_mode/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/tmr/tmr_timer_mode/readme.html#downloading-and-building-the-application"
  },"111": {
    "doc": "TMR periodic interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/tmr/tmr_timer_mode/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/tmr/tmr_timer_mode/readme.html#setting-up-the-hardware"
  },"112": {
    "doc": "TMR periodic interrupt",
    "title": "Running the Application",
    "content": ". | Build and program the application project using its IDE | On successful execution, LED starts blinking | . Following table provides the LED names: . | Board | LED name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/tmr/tmr_timer_mode/readme.html#running-the-application",
    "relUrl": "/apps/tmr/tmr_timer_mode/readme.html#running-the-application"
  },"113": {
    "doc": "TMR periodic interrupt",
    "title": "TMR periodic interrupt",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/tmr/tmr_timer_mode/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/tmr1/tmr1_timer_mode/readme.html#tmr1-periodic-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/tmr1/tmr1_timer_mode/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/tmr1/tmr1_timer_mode/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/tmr1/tmr1_timer_mode/readme.html#downloading-and-building-the-application"
  },"117": {
    "doc": "TMR1 periodic interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/tmr1/tmr1_timer_mode/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/tmr1/tmr1_timer_mode/readme.html#setting-up-the-hardware"
  },"118": {
    "doc": "TMR1 periodic interrupt",
    "title": "Running the Application",
    "content": ". | Build and program the application project using its IDE | On successful execution, LED starts blinking | . Following table provides the LED names: . | Board | LED name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/tmr1/tmr1_timer_mode/readme.html#running-the-application",
    "relUrl": "/apps/tmr1/tmr1_timer_mode/readme.html#running-the-application"
  },"119": {
    "doc": "TMR1 periodic interrupt",
    "title": "TMR1 periodic interrupt",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/tmr1/tmr1_timer_mode/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_echo_blocking/readme.html#uart-echo-blocking",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_echo_blocking/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_echo_blocking/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/uart/uart_echo_blocking/readme.html#downloading-and-building-the-application"
  },"123": {
    "doc": "UART echo blocking",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_echo_blocking/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/uart/uart_echo_blocking/readme.html#setting-up-the-hardware"
  },"124": {
    "doc": "UART echo blocking",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the “USB to UART” COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application project using its IDE | See the following message in the console: . | Type a line of characters and press the Enter key | Entered line will be echoed back and the LED is toggled | . Following table provides the LED names: . | Board | LED name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_echo_blocking/readme.html#running-the-application",
    "relUrl": "/apps/uart/uart_echo_blocking/readme.html#running-the-application"
  },"125": {
    "doc": "UART echo blocking",
    "title": "UART echo blocking",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_echo_blocking/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_echo_interrupt/readme.html#uart-echo-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_echo_interrupt/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_echo_interrupt/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/uart/uart_echo_interrupt/readme.html#downloading-and-building-the-application"
  },"129": {
    "doc": "UART echo interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_daa_sk.X | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_echo_interrupt/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/uart/uart_echo_interrupt/readme.html#setting-up-the-hardware"
  },"130": {
    "doc": "UART echo interrupt",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the “USB to UART” COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application project using its IDE | See the following message in the console: . | Type 10 characters in terminal | Entered 10 characters is echoed back and LED is toggled | . Following table provides the LED names: . | Board | LED name | . | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | LED1 | . |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_echo_interrupt/readme.html#running-the-application",
    "relUrl": "/apps/uart/uart_echo_interrupt/readme.html#running-the-application"
  },"131": {
    "doc": "UART echo interrupt",
    "title": "UART echo interrupt",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_echo_interrupt/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_ring_buffer_interrupt/readme.html#uart-ring-buffer",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_ring_buffer_interrupt/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_ring_buffer_interrupt/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/uart/uart_ring_buffer_interrupt/readme.html#downloading-and-building-the-application"
  },"135": {
    "doc": "UART ring buffer",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_daa_sk.X | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | Connect the USB to UART port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_ring_buffer_interrupt/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_ring_buffer_interrupt/readme.html#running-the-application",
    "relUrl": "/apps/uart/uart_ring_buffer_interrupt/readme.html#running-the-application"
  },"137": {
    "doc": "UART ring buffer",
    "title": "UART ring buffer",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/uart/uart_ring_buffer_interrupt/readme.html",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/wdt/wdt_timeout/readme.html#wdt-timeout",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/wdt/wdt_timeout/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/wdt/wdt_timeout/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/wdt/wdt_timeout/readme.html#downloading-and-building-the-application"
  },"141": {
    "doc": "WDT timeout",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/wdt/wdt_timeout/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/wdt/wdt_timeout/readme.html#setting-up-the-hardware"
  },"142": {
    "doc": "WDT timeout",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the EDBG Virtual COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application project using its IDE | LED should be blinking and the console displays the following message . | Press the switch to put the system in a deadlock | LED should stop blinking and the console should print the following message . | WDT will reset the device in four seconds and the demonstration should restart | . Refer the table below for details of switch and LED: . | Board | Switch Name | LED Name | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | SW1 | LED1 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | SW1 | LED1 | . |   |   |   | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/wdt/wdt_timeout/readme.html#running-the-application",
    "relUrl": "/apps/wdt/wdt_timeout/readme.html#running-the-application"
  },"143": {
    "doc": "WDT timeout",
    "title": "WDT timeout",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/wdt/wdt_timeout/readme.html",
    "relUrl": "/apps/wdt/wdt_timeout/readme.html"
  },"144": {
    "doc": "ADCHS Interrupt",
    "title": "ADCHS Interrupt",
    "content": "This example application shows how to sample an analog input using the ADCHS peripheral and displays the converted samples on a serial terminal. ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/adchs/adchs_interrupt/readme.html#adchs-interrupt",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/adchs/adchs_interrupt/readme.html#description",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/adchs/adchs_interrupt/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/adchs/adchs_interrupt/readme.html#downloading-and-building-the-application"
  },"147": {
    "doc": "ADCHS Interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mz_dag_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | . | pic32mz_das_sk.X | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | . |   |   | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit . | Connect the AN3 pin RB15 (Pin 36 of the J15) to the Vcc (Pin 1 of the J15) | Connect the COM port J5(UART-USB) to the computer using a micro USB cable | Connect the Debug USB port on the board to the computer using a micro USB cable | . Setting up PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) . | Connect the AN3 pin RB15 (Pin 36 of the J15) to the Vcc (Pin 1 of the J15) | Connect the COM port J5(UART-USB) to the computer using a micro USB cable | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/adchs/adchs_interrupt/readme.html#setting-up-the-hardware",
    "relUrl": "/apps/adchs/adchs_interrupt/readme.html#setting-up-the-hardware"
  },"148": {
    "doc": "ADCHS Interrupt",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the “USB to UART” COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application project using its IDE | Console displays the ADC count and the ADC input voltage | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/adchs/adchs_interrupt/readme.html#running-the-application",
    "relUrl": "/apps/adchs/adchs_interrupt/readme.html#running-the-application"
  },"149": {
    "doc": "ADCHS Interrupt",
    "title": "ADCHS Interrupt",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/apps/adchs/adchs_interrupt/readme.html",
    "relUrl": "/apps/adchs/adchs_interrupt/readme.html"
  },"150": {
    "doc": "Release notes",
    "title": "Microchip MPLAB® Harmony 3 Release Notes",
    "content": " ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/release_notes.html#microchip-mplab-harmony-3-release-notes",
    "relUrl": "/release_notes.html#microchip-mplab-harmony-3-release-notes"
  },"151": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MZ DA family  v3.4.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | 19 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | 24 | . | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | 4 | . | PIC32MZ DA Curiosity Development Kit | 1 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.05 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.3.0 | . | MPLAB® XC32 C/C++ Compiler v4.21 | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v340",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v340"
  },"152": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MZ DA family  v3.3.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | 19 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | 24 | . | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | 4 | . | PIC32MZ DA Curiosity Development Kit | 1 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.00 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.1.9 | . | MPLAB® XC32 C/C++ Compiler v4.10 | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v330",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v330"
  },"153": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MZ DA family  v3.2.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | 19 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | 24 | . | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | 4 | . | PIC32MZ DA Curiosity Development Kit | 1 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v5.50 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.8.0 | . | MPLAB® XC32 C/C++ Compiler v3.01 | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v320",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v320"
  },"154": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MZ DA family  v3.1.1",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v311",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v311"
  },"155": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MZ DA family  v3.1.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | 4 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | 19 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | 24 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v5.45 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.7.0 | . | MPLAB® XC32 C/C++ Compiler v2.50 | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v310",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v310"
  },"156": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MZ DA family  v3.0.1",
    ...
    "url": "http://localhost:4000/csp_apps_pic32mz_da/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v301",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v301"
  },"157": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MZ DA family  v3.0.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | PIC32MZ Embedded Graphics with External DRAM (DA) Starter Kit | 4 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit | 19 | . | PIC32MZ Embedded Graphics with Stacked DRAM (DA) Starter Kit (Crypto) | 24 | . New Features . New features added in this release are as follows: . | Applications migrated from csp repository to this new application repository for PIC32MZ DA development boards | . Known Issues . The current known issues are as follows: . | None | . Development Tools . | MPLAB® X IDE v5.40 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.6.0 | . | MPLAB® XC32 C/C++ Compiler v2.41 | . ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v300",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mz-da-family--v300"
  },"158": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": ". ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/release_notes.html",
    "relUrl": "/release_notes.html"
  },"159": {
    "doc": "Harmony 3 peripheral library application examples for PIC32MZ DA family",
    "title": "Harmony 3 peripheral library application examples for PIC32MZ DA family",
    "content": "[![MCHP](https://www.microchip.com/ResourcePackages/Microchip/assets/dist/images/logo.png)](https://www.microchip.com) # Harmony 3 peripheral library application examples for PIC32MZ DA family MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) This repository contains the MPLAB® Harmony 3 peripheral library application examples for PIC32MZ DA family - [Release Notes](/csp_apps_pic32mz_da/release_notes.html) - [MPLAB® Harmony License](/csp_apps_pic32mz_da/mplab_harmony_license.html) To clone or download these applications from Github, go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/csp_apps_pic32mz_da) and then click **Clone** button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these [instructions](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki). ## Contents Summary | Folder | Description | --- | --- | apps | Contains peripheral library example applications | docs | Contains documentation in html format for offline viewing (to be used only after cloning this repository onto a local machine). Use [github pages](https://microchip-mplab-harmony.github.io/csp_apps_pic32mz_da/) of this repository for viewing it online. | ## Code Examples The following applications are provided to demonstrate the typical or interesting usage models of one or more peripheral libraries. | Name | Description | ---- | ----------- | [ADCHS Interrupt](/csp_apps_pic32mz_da/apps/adchs/adchs_interrupt/readme.html) | This example application shows how to sample an analog input using the ADCHS peripheral and displays the converted samples on a serial terminal | [ADCHS polling](/csp_apps_pic32mz_da/apps/adchs/adchs_polled/readme.html) | This example application shows how to sample an analog input using the ADCHS peripheral and displays the converted samples on a serial terminal | [Cache maintenance operations](/csp_apps_pic32mz_da/apps/cache/cache_maintenance/readme.html) | This example demonstrates the cache maintenance operation by cleaning and invalidating the cache for the DMA buffers located in the cacheable SRAM region | [CMP configurable reference](/csp_apps_pic32mz_da/apps/cmp/cmp_configurable_reference/readme.html) | This example application shows how to use the CMP Peripheral library to compare voltage level on the negative input with the internal configurable reference voltage | [CORETIMER periodic interrupt](/csp_apps_pic32mz_da/apps/coretimer/coretimer_periodic_timeout/readme.html) | This example application shows how to use the CoreTimer to generate periodic interrupts | [DMAC memory transfer](/csp_apps_pic32mz_da/apps/dmac/dmac_memory_transfer/readme.html) | This example application demonstrates how to use the DMAC peripheral to do a memory to memory transfer | [DMAC usart echo](/csp_apps_pic32mz_da/apps/dmac/dmac_usart_echo/readme.html) | This example application demonstrates USART transfer with DMA to receive 10 bytes and echo back the received bytes | [DMT timeout](/csp_apps_pic32mz_da/apps/dmt/dmt_timeout/readme.html) | This example application shows how the deadman timer resets by not clearing the deadman timer counter on switch press | [GPIO interrupt](/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_interrupt/readme.html) | This example application demonstrate how to generate GPIO interrupt on switch press and release, and indicate the switch status using the LED | [GPIO Polling](/csp_apps_pic32mz_da/apps/gpio/gpio_led_on_off_polling/readme.html) | This example application demonstrate how to poll the switch input, and indicate the switch status using the LED | [I2C EEPROM read write](/csp_apps_pic32mz_da/apps/i2c/master/i2c_eeprom/readme.html) | This example application demonstrates how to use the I2C peripheral to write and read from the I2C serial EEPROM memory | [ICAP capture mode](/csp_apps_pic32mz_da/apps/icap/icap_capture_mode/readme.html) | This example application shows how to use the ICAP peripheral to measure the pulse width of the input signal | [NVM flash read write](/csp_apps_pic32mz_da/apps/nvm/flash_read_write/readme.html) | This example application demonstrates how to use the NVM to erase and program the internal Flash memory | [OCMP compare mode](/csp_apps_pic32mz_da/apps/ocmp/ocmp_compare_mode/readme.html) | This example application shows how to use the OCMP peripheral to generate an active low, active high, and toggle output on compare match | [RNG random number](/csp_apps_pic32mz_da/apps/rng/rng_random_number/readme.html) | This example application shows how to use the RNG Peripheral library to generate a pseudo-random number | [RTCC alarm interrupt](/csp_apps_pic32mz_da/apps/rtcc/rtcc_alarm/readme.html) | This example application shows how to use the RTCC to configure the time and generate the alarm | [SPI blocking](/csp_apps_pic32mz_da/apps/spi/spi_self_loopback_blocking/readme.html) | This example application demonstrates how to use the SPI peripheral to transmit and receive a block of data in a blocking manner | [SPI interrupt](/csp_apps_pic32mz_da/apps/spi/spi_self_loopback_interrupt/readme.html) | This example application demonstrates how to use the SPI peripheral to transmit and receive a block of data using interrupt | [SQI flash read write](/csp_apps_pic32mz_da/apps/sqi/sqi_read_write/readme.html) | This example application demonstrates how to use the SQI Peripheral library to perform erase, write and read operation with the SQI Serial Flash memory | [TMR periodic interrupt](/csp_apps_pic32mz_da/apps/tmr/tmr_timer_mode/readme.html) | This example demonstrates how to use the TMR module in timer mode to generate periodic interrupt | [TMR1 periodic interrupt](/csp_apps_pic32mz_da/apps/tmr1/tmr1_timer_mode/readme.html) | This example demonstrates how to use the TMR1 module in timer mode to generate periodic interrupt | [UART echo blocking](/csp_apps_pic32mz_da/apps/uart/uart_echo_blocking/readme.html) | This example application demonstrates how to use the UART peripheral to transfer a block of data in a blocking manner | [UART echo interrupt](/csp_apps_pic32mz_da/apps/uart/uart_echo_interrupt/readme.html) | This example application demonstrates how to use the UART peripheral to transfer a block of data in a non-blocking manner | [UART ring buffer](/csp_apps_pic32mz_da/apps/uart/uart_ring_buffer_interrupt/readme.html) | This example application demonstrates how to use the UART peripheral in ring buffer mode | [WDT timeout](/csp_apps_pic32mz_da/apps/wdt/wdt_timeout/readme.html) | This example application shows how the watchdog timer resets by not feeding the watchdog on switch press | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/csp_apps_pic32mz_da/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/Microchip-MPLAB-Harmony/csp_apps_pic32mz_da.svg)](https://github.com/Microchip-MPLAB-Harmony/csp_apps_pic32mz_da/releases/latest) [![Latest release date](https://img.shields.io/github/release-date/Microchip-MPLAB-Harmony/csp_apps_pic32mz_da.svg)](https://github.com/Microchip-MPLAB-Harmony/csp_apps_pic32mz_da/releases/latest) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/csp_apps_pic32mz_da.svg)](https://github.com/Microchip-MPLAB-Harmony/csp_apps_pic32mz_da/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/csp_apps_pic32mz_da.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/csp_apps_pic32mz_da.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/csp_apps_pic32mz_da.svg?style=social)]() ",
    "url": "http://localhost:4000/csp_apps_pic32mz_da/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "csp_apps_pic32mz_da";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 peripheral library application examples for PIC32MZ DA family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/csp_apps_pic32mz_da/assets/css/just-the-docs-' + theme + '.css');
}
